...
Task tSensor(2 * TASK_SECOND, TASK_FOREVER, &vSensorTask, &runner);
Task tControl(1 * TASK_SECOND, TASK_FOREVER, &vControlTask, &runner);
Task tMotor(300 * TASK_MILLISECOND, TASK_FOREVER, &vMotorTask, &runner);
Task tPID(200 * TASK_MILLISECOND, TASK_FOREVER, &vPIDTask, &runner);
...
//  MDNS.addService("http", "tcp", 80);
  ...
  // Heating process
  _PL("Heating MQ2 for 20 seconds...");
